...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dregni_event', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dregni_events', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Event.created'
        db.add_column('dregni_event', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Event.modified'
        db.add_column('dregni_event', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.now, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Event.creator'
        db.delete_column('dregni_event', 'creator_id')

        # Deleting field 'Event.created'
        db.delete_column('dregni_event', 'created')

        # Deleting field 'Event.modified'
        db.delete_column('dregni_event', 'modified')
    ...
    models = {
        ...
        'dregni.event': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dregni_events'", 'null': 'True', 'to': "orm['auth.User']"}),
